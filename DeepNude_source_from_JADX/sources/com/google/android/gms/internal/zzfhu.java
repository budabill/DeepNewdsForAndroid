...
public abstract class zzfhu<MessageType extends zzfhu<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzfgj<MessageType, BuilderType> {
    ...
    public enum zzg {
        ...
        public static int[] m1266x126d66cb() {
        ...
        public final <T extends zzfjc> T zza(T t, T t2) {
            ...
            if (t == null) {
                ...
                if (obj.zzpno == 0) {
                    ...
                    zzfko zzfko = obj.zzpph;
                    obj.zzpph = zza(zzfko, zzfko);
    ...
    public static abstract class zza<MessageType extends zzfhu<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzfgk<MessageType, BuilderType> {
        ...
        public final /* synthetic */ zzfgk zza(zzfhb zzfhb, zzfhm zzfhm) {
        ...
        public final /* synthetic */ zzfjd zzb(zzfhb zzfhb, zzfhm zzfhm) {
            zzd(zzfhb, zzfhm);
            return this;
        }
        ...
        public final MessageType zzczx() {
            ...
            byte byteValue = ((Byte) messageType.zza(zzg.zzppt, null, null)).byteValue();
            if (byteValue != (byte) 1) {
                if (byteValue == (byte) 0) {
                    z = false;
                } else {
                    if (messageType.zza(zzg.zzppr, Boolean.FALSE, null) == null) {
                        z = false;
                    }
                    if (booleanValue) {
                        messageType.zza(zzg.zzppu, z ? messageType : null, null);
                    }
                }
            }
            if (z) {
        ...
        public final /* synthetic */ zzfjc zzczz() {
            ...
            zzfjc zzfjc = this.zzppl;
            boolean booleanValue = Boolean.TRUE.booleanValue();
            byte byteValue = ((Byte) zzfjc.zza(zzg.zzppt, null, null)).byteValue();
            if (byteValue != (byte) 1) {
                if (byteValue == (byte) 0) {
                    z = false;
                } else {
                    if (zzfjc.zza(zzg.zzppr, Boolean.FALSE, null) == null) {
                        z = false;
                    }
                    if (booleanValue) {
                        zzfjc.zza(zzg.zzppu, z ? zzfjc : null, null);
                    }
                }
            }
            if (z) {
...
*/
    ...
    L_0x0003:
        return r0;
    L_0x0004:
        r1 = com.google.android.gms.internal.zzfhu.zzg.zzppz;
        r2 = 0;
        r1 = r4.zza(r1, r2, r2);
        r1 = (com.google.android.gms.internal.zzfhu) r1;
        r1 = r1.getClass();
        r1 = r1.isInstance(r5);
        r2 = 0;
    ...
    L_0x0018:
        return r2;
    L_0x0019:
        r1 = com.google.android.gms.internal.zzfhu.zzc.zzppn;	 Catch:{ zzfhv -> 0x002d }
        r5 = (com.google.android.gms.internal.zzfhu) r5;	 Catch:{ zzfhv -> 0x002d }
        r3 = com.google.android.gms.internal.zzfhu.zzg.zzpps;	 Catch:{ zzfhv -> 0x002d }
        r4.zza(r3, r1, r5);	 Catch:{ zzfhv -> 0x002d }
        r3 = r4.zzpph;	 Catch:{ zzfhv -> 0x002d }
        r5 = r5.zzpph;	 Catch:{ zzfhv -> 0x002d }
        r5 = r1.zza(r3, r5);	 Catch:{ zzfhv -> 0x002d }
        r4.zzpph = r5;	 Catch:{ zzfhv -> 0x002d }
        return r0;
    L_0x002d:
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzfhu.equals(java.lang.Object):boolean");
    }
