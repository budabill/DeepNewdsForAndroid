...
public abstract class zzfhg extends zzfgr {
        ...
        final void zzdd(long j) {
            ...
            if (zzfhg.zzpop) {
                ...
                while ((j & -128) != 0) {
                    ...
                    this.position = i3 + 1;
                    zzfkq.zza(bArr, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                bArr = this.buffer;
                i2 = this.position;
                ...
                i = this.zzpor + ((int) (((long) this.position) - j2));
            } else {
                while ((j & -128) != 0) {
                    bArr = this.buffer;
    ...
    public static int zztx(java.lang.String r1) {
...
*/
        /*
        r1 = com.google.android.gms.internal.zzfks.zzd(r1);	 Catch:{ zzfkv -> 0x0005 }
        goto L_0x000c;
    L_0x0005:
        r0 = com.google.android.gms.internal.zzfhz.UTF_8;
        r1 = r1.getBytes(r0);
        r1 = r1.length;
    L_0x000c:
        r0 = zzly(r1);
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzfhg.zztx(java.lang.String):int");
    }
