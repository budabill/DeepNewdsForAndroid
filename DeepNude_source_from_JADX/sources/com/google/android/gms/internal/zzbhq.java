...
public final class zzbhq<I, O> extends zzbgl {
    ...
    public final String toString() {
        ...
        zzbi zzg = zzbg.zzx(this).zzg("versionCode", Integer.valueOf(this.zzehz)).zzg(str, Integer.valueOf(this.zzgio)).zzg(str, Boolean.valueOf(this.zzgip)).zzg(str, Integer.valueOf(this.zzgiq)).zzg(str, Boolean.valueOf(this.zzgir)).zzg(str, this.zzgis).zzg(str, Integer.valueOf(this.zzgit)).zzg(str, zzanf());
        Class cls = this.zzgiu;
        if (cls != null) {
            zzg.zzg("concreteType.class", cls.getCanonicalName());
        }
        zzbhr zzbhr = this.zzgix;
        if (zzbhr != null) {
            zzg.zzg("converterName", zzbhr.getClass().getCanonicalName());
        }
        return zzg.toString();
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbhr zzbhr = this.zzgix;
        zzbgo.zza(parcel, 9, zzbhr == null ? null : zzbhj.zza(zzbhr), i, false);
