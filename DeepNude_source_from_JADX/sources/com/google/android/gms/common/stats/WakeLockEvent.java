...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String zzano() {
        ...
        int i = this.zzgka;
        Iterable iterable = this.zzgkb;
        String str2 = "";
        String join = iterable == null ? str2 : TextUtils.join(",", iterable);
        int i2 = this.zzgke;
        ...
        StringBuilder stringBuilder = new StringBuilder(((((String.valueOf(str).length() + 45) + String.valueOf(join).length()) + String.valueOf(str3).length()) + String.valueOf(str4).length()) + String.valueOf(str2).length());
        str5 = "\t";
