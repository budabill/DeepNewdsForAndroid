...
public final class zzae implements Callback {
    ...
    L_0x0011:
        ...
        r0 = r7.mLock;
        monitor-enter(r0);
        r1 = new java.util.ArrayList;	 Catch:{ all -> 0x0056 }
        r3 = r7.zzggo;	 Catch:{ all -> 0x0056 }
        r1.<init>(r3);	 Catch:{ all -> 0x0056 }
        r3 = r7.zzggq;	 Catch:{ all -> 0x0056 }
        r3 = r3.get();	 Catch:{ all -> 0x0056 }
        r4 = r1.size();	 Catch:{ all -> 0x0056 }
    L_0x002f:
        if (r2 >= r4) goto L_0x0054;
    L_0x0031:
        r5 = r1.get(r2);	 Catch:{ all -> 0x0056 }
        r2 = r2 + 1;
        r5 = (com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener) r5;	 Catch:{ all -> 0x0056 }
    ...
    L_0x0046:
        ...
        r6 = r6.contains(r5);	 Catch:{ all -> 0x0056 }
