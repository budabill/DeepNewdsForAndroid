...
public final class zzdc extends Fragment implements zzcf {
    ...
    public static zzdc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            zzdc = (zzdc) fragmentActivity.getSupportFragmentManager().findFragmentByTag(str);
            if (zzdc == null || zzdc.isRemoving()) {
                zzdc = new zzdc();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) zzdc, str).commitAllowingStateLoss();
            }
