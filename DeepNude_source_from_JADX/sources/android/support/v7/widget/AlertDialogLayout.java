...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0222R.id.topPanel) {
                    view = childAt;
                } else if (id == C0222R.id.buttonPanel) {
                    view2 = childAt;
                } else {
                    if (id != C0222R.id.contentPanel) {
                        if (id != C0222R.id.customPanel) {
                            return false;
                        }
                    }
                    if (view3 != null) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        i5 = i6 != 16 ? i6 != 80 ? getPaddingTop() : ((getPaddingTop() + i4) - i2) - i5 : getPaddingTop() + (((i4 - i2) - i5) / 2);
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8)) {
                ...
                if (i6 == 1) {
                    ...
                    i9 = i5 + layoutParams.topMargin;
                    setChildFrame(childAt, i6, i9, measuredWidth, measuredHeight);
                    i5 = i9 + (measuredHeight + layoutParams.bottomMargin);
                } else {
