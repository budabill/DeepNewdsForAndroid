...
class CardViewBaseImpl implements CardViewImpl {
    ...
    class C07931 implements RoundRectHelper {
        C07931() {
        }
        ...
        public void drawRoundRect(Canvas canvas, RectF rectF, float f, Paint paint) {
            ...
            if (f >= 1.0f) {
                ...
                f4 = (rectF2.left + f3) - 1.0f;
                float f5 = rectF2.top;
                canvas.drawRect(f4, f5, (rectF2.right - f3) + 1.0f, f5 + f3, paint2);
                f4 = (rectF2.left + f3) - 1.0f;
                float f6 = rectF2.bottom;
                canvas.drawRect(f4, f6 - f3, (rectF2.right - f3) + 1.0f, f6, paint2);
            }
    ...
    public void initStatic() {
        RoundRectDrawableWithShadow.sRoundRectHelper = new C07931();
    }
