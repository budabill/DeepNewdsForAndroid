...
*/
            ...
            r6 = 0;
            r7 = android.support.v7.widget.ActivityChooserModel.this;	 Catch:{ FileNotFoundException -> 0x00e0 }
            ...
            r8 = "UTF-8";	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            ...
            r9 = 0;	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
        L_0x0031:
            if (r9 >= r8) goto L_0x0063;	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
        L_0x0033:
            r10 = r4.remove(r3);	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            r10 = (android.support.v7.widget.ActivityChooserModel.HistoricalRecord) r10;	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            r7.startTag(r6, r0);	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            r11 = "activity";	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            ...
            r11 = "time";	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            ...
            r7.attribute(r6, r11, r12);	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            r11 = "weight";	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            ...
            r9 = r9 + 1;	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
            goto L_0x0031;	 Catch:{ IllegalArgumentException -> 0x00b5, IllegalStateException -> 0x0095, IOException -> 0x0075 }
        L_0x0063:
        ...
        L_0x0075:
            r0 = move-exception;
            r1 = android.support.v7.widget.ActivityChooserModel.LOG_TAG;	 Catch:{ all -> 0x0073 }
            r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0073 }
            r3.<init>();	 Catch:{ all -> 0x0073 }
            r3.append(r2);	 Catch:{ all -> 0x0073 }
            r2 = android.support.v7.widget.ActivityChooserModel.this;	 Catch:{ all -> 0x0073 }
...
*/
        ...
        r3 = "UTF-8";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r2.setInput(r1, r3);	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r3 = 0;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x0014:
        r4 = 1;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        if (r3 == r4) goto L_0x001f;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x0017:
        r5 = 2;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        if (r3 == r5) goto L_0x001f;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x001a:
        r3 = r2.next();	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        goto L_0x0014;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x001f:
        r3 = "historical-records";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        ...
        if (r3 == 0) goto L_0x007c;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x002b:
    ...
    L_0x0044:
        r5 = r2.getName();	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r6 = "historical-record";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r5 = r6.equals(r5);	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        if (r5 == 0) goto L_0x0074;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x0050:
        r5 = "activity";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r6 = 0;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r5 = r2.getAttributeValue(r6, r5);	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r7 = "time";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        ...
        r9 = "weight";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        ...
        r9 = new android.support.v7.widget.ActivityChooserModel$HistoricalRecord;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        ...
        goto L_0x0030;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x0074:
        r2 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r3 = "Share records file not well-formed.";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    ...
    L_0x007c:
        r2 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r3 = "Share records file does not start with historical-records tag.";	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        r2.<init>(r3);	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        throw r2;	 Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
    L_0x0084:
        r0 = move-exception;
    ...
    L_0x0086:
        ...
        if (r1 == 0) goto L_0x00bb;	 Catch:{ all -> 0x0084 }
    L_0x009f:
        goto L_0x0038;	 Catch:{ all -> 0x0084 }
    L_0x00a0:
        r2 = move-exception;	 Catch:{ all -> 0x0084 }
        r3 = LOG_TAG;	 Catch:{ all -> 0x0084 }
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0084 }
        r4.<init>();	 Catch:{ all -> 0x0084 }
        r4.append(r0);	 Catch:{ all -> 0x0084 }
