...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    class C07861 implements VisibilityListener {
        C07861() {
        }
    ...
    String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            stringBuilder.append(resources.getString(C0222R.string.abc_prepend_shortcut_label));
        }
        int i2 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(stringBuilder, i2, 65536, resources.getString(C0222R.string.abc_menu_meta_shortcut_label));
        appendModifier(stringBuilder, i2, 4096, resources.getString(C0222R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(stringBuilder, i2, 2, resources.getString(C0222R.string.abc_menu_alt_shortcut_label));
        appendModifier(stringBuilder, i2, 1, resources.getString(C0222R.string.abc_menu_shift_shortcut_label));
        appendModifier(stringBuilder, i2, 4, resources.getString(C0222R.string.abc_menu_sym_shortcut_label));
        appendModifier(stringBuilder, i2, 8, resources.getString(C0222R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
            i = C0222R.string.abc_menu_delete_shortcut_label;
        } else if (shortcut == '\n') {
            i = C0222R.string.abc_menu_enter_shortcut_label;
        } else if (shortcut != ' ') {
            stringBuilder.append(shortcut);
            return stringBuilder.toString();
        } else {
            i = C0222R.string.abc_menu_space_shortcut_label;
        }
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        if (actionProvider != null) {
            actionProvider.setVisibilityListener(new C07861());
        }
        return this;
    }
