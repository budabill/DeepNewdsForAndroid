...
public class MenuPopupHelper implements MenuHelper {
    ...
    class C02291 implements OnDismissListener {
        C02291() {
        }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0222R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0222R.attr.popupMenuStyle, 0);
    }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z, int i, int i2) {
        ...
        this.mInternalOnDismissListener = new C02291();
    ...
    private MenuPopup createPopup() {
        ...
        if ((Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0222R.dimen.abc_cascading_menus_min_smallest_width) ? 1 : null) != null) {
    ...
    public boolean isShowing() {
        ShowableListMenu showableListMenu = this.mPopup;
    ...
    public void setPresenterCallback(Callback callback) {
        ...
        MenuPresenter menuPresenter = this.mPopup;
        if (menuPresenter != null) {
            menuPresenter.setCallback(callback);
        }
    }
