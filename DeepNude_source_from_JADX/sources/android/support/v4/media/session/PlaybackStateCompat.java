...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder(PlaybackStateCompat playbackStateCompat) {
            ...
            Collection collection = playbackStateCompat.mCustomActions;
            if (collection != null) {
    ...
    public Object getPlaybackState() {
        if (this.mStateObj == null && VERSION.SDK_INT >= 21) {
            ...
            List list3 = list;
            if (VERSION.SDK_INT >= 22) {
                newInstance = PlaybackStateCompatApi22.newInstance(r0.mState, r0.mPosition, r0.mBufferedPosition, r0.mSpeed, r0.mActions, r0.mErrorMessage, r0.mUpdateTime, list3, r0.mActiveItemId, r0.mExtras);
            } else {
                newInstance = PlaybackStateCompatApi21.newInstance(r0.mState, r0.mPosition, r0.mBufferedPosition, r0.mSpeed, r0.mActions, r0.mErrorMessage, r0.mUpdateTime, list3, r0.mActiveItemId);
            }
            r0.mStateObj = newInstance;
        }
        return r0.mStateObj;
    }
