...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01022();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01011();
    ...
    class C01022 implements OnItemClickListener {
        C01022() {
        }
