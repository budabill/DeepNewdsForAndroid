        ...
        while (i < backStackRecord.mOps.size()) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment5.mContainerId == i3) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    backStackRecord.mOps.add(i4, new Op(9, fragment5));
                                    i4++;
                                    fragment4 = null;
                                }
                                ...
                                backStackRecord.mOps.add(i4, op2);
                    ...
                    if (obj != null) {
                        backStackRecord.mOps.remove(i4);
                        i4--;
                    } else {
                        op.cmd = 1;
                    ...
                    if (fragment6 == fragment2) {
                        backStackRecord.mOps.add(i, new Op(9, fragment6));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        backStackRecord.mOps.add(i, new Op(9, fragment2));
                        i++;
            ...
            if (!(i5 == 0 || i5 == r3)) {
                for (i3 = i; i3 < i2; i3++) {
                    ...
                    for (int i6 = 0; i6 < size2; i6++) {
                        Fragment fragment2 = ((Op) backStackRecord.mOps.get(i6)).fragment;
