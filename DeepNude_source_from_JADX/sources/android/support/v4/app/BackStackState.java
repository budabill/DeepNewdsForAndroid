...
final class BackStackState implements Parcelable {
    public static final Creator<BackStackState> CREATOR = new C00771();
    ...
    static class C00771 implements Creator<BackStackState> {
        C00771() {
        }
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        if (backStackRecord.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                iArr[i3] = op.exitAnim;
                i3 = i + 1;
                iArr[i] = op.popEnterAnim;
                i = i3 + 1;
                iArr[i3] = op.popExitAnim;
            }
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i < this.mOps.length) {
            ...
            int i4 = i3 + 1;
            i = this.mOps[i3];
            op.fragment = i >= 0 ? (Fragment) fragmentManagerImpl.mActive.get(i) : null;
            int[] iArr = this.mOps;
            i3 = i4 + 1;
