...
final class FragmentState implements Parcelable {
    public static final Creator<FragmentState> CREATOR = new C00871();
    ...
    static class C00871 implements Creator<FragmentState> {
        C00871() {
        }
    ...
    public Fragment instantiate(FragmentHostCallback fragmentHostCallback, FragmentContainer fragmentContainer, Fragment fragment, FragmentManagerNonConfig fragmentManagerNonConfig, C0073s c0073s) {
        ...
        fragment3.mViewModelStore = c0073s;
        return fragment3;
    }
