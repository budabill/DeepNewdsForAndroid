...
class TypefaceCompatBaseImpl {
    ...
    class C07561 implements StyleExtractor<FontInfo> {
        C07561() {
        }
    ...
    class C07572 implements StyleExtractor<FontFileResourceEntry> {
        C07572() {
        }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C07572());
    }
...
*/
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C07561());
    }
}
