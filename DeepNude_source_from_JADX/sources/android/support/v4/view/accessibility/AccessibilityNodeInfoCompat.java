...
public class AccessibilityNodeInfoCompat {
    ...
    public CharSequence getHintText() {
        ...
        return i >= 26 ? this.mInfo.getHintText() : i >= 19 ? this.mInfo.getExtras().getCharSequence(HINT_TEXT_KEY) : null;
    }
    ...
    public CharSequence getPaneTitle() {
        int i = VERSION.SDK_INT;
        return i >= 28 ? this.mInfo.getPaneTitle() : i >= 19 ? this.mInfo.getExtras().getCharSequence(PANE_TITLE_KEY) : null;
    }
    ...
    public CharSequence getTooltipText() {
        int i = VERSION.SDK_INT;
        return i >= 28 ? this.mInfo.getTooltipText() : i >= 19 ? this.mInfo.getExtras().getCharSequence(TOOLTIP_TEXT_KEY) : null;
    }
