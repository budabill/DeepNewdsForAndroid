...
public class ViewDragHelper {
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        i2 = Math.abs(i2);
        return Math.min(i2 > 0 ? Math.round(Math.abs(f / ((float) i2)) * 1000.0f) * 4 : (int) (((((float) Math.abs(i)) / ((float) i3)) + 1.0f) * 256.0f), MAX_SETTLE_DURATION);
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
                ...
                if (actionMasked == 2) {
                    if (this.mDragState != 1) {
                        ...
                        while (i < actionMasked) {
                            ...
                            if (isValidPointerForActionMove(actionIndex)) {
                                float x = motionEvent.getX(i);
                                float y = motionEvent.getY(i);
                                float f = x - this.mInitialMotionX[actionIndex];
                                float f2 = y - this.mInitialMotionY[actionIndex];
                                reportNewEdgeDrags(f, f2, actionIndex);
                                if (this.mDragState != 1) {
                                    View findTopChildUnder = findTopChildUnder((int) x, (int) y);
                                    if (checkTouchSlop(findTopChildUnder, f, f2) && tryCaptureViewForDrag(findTopChildUnder, actionIndex)) {
                                        break;
                                    }
                                }
                                break;
                        ...
                        actionIndex = (int) (x2 - fArr[i3]);
                        actionMasked = (int) (y2 - this.mLastMotionY[i3]);
                    ...
                    if (actionMasked == 5) {
                        ...
                        if (this.mDragState == 0) {
                            ...
                            i2 = this.mInitialEdgesTouched[actionMasked];
                            actionIndex = this.mTrackingEdges;
                            if ((i2 & actionIndex) != 0) {
                                this.mCallback.onEdgeTouched(i2 & actionIndex, actionMasked);
                                return;
                            }
                            return;
                        ...
                        if (this.mDragState == 1 && actionMasked == this.mActivePointerId) {
                            ...
                            while (i < actionIndex) {
                                ...
                                if (pointerId != this.mActivePointerId) {
                                    ...
                                    if (findTopChildUnder2 == view && tryCaptureViewForDrag(view, pointerId)) {
        ...
        View findTopChildUnder3 = findTopChildUnder((int) y2, (int) x2);
        saveInitialMotion(y2, x2, i2);
        tryCaptureViewForDrag(findTopChildUnder3, i2);
        actionMasked = this.mInitialEdgesTouched[i2];
        actionIndex = this.mTrackingEdges;
        if ((actionMasked & actionIndex) != 0) {
            this.mCallback.onEdgeTouched(actionMasked & actionIndex, i2);
        }
    }
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                if (actionMasked != 2) {
                    if (actionMasked != 3) {
                        if (actionMasked == 5) {
                            ...
                            saveInitialMotion(x, y, actionMasked);
                            actionIndex = viewDragHelper.mDragState;
                            if (actionIndex == 0) {
                                i = viewDragHelper.mInitialEdgesTouched[actionMasked];
                                actionIndex = viewDragHelper.mTrackingEdges;
                                if ((i & actionIndex) != 0) {
                                    viewDragHelper.mCallback.onEdgeTouched(i & actionIndex, actionMasked);
                                }
                            } else if (actionIndex == 2) {
                                View findTopChildUnder = findTopChildUnder((int) x, (int) y);
                                if (findTopChildUnder == viewDragHelper.mCapturedView) {
                                    tryCaptureViewForDrag(findTopChildUnder, actionMasked);
                                }
                            }
                        } else if (actionMasked == 6) {
                ...
                } else if (viewDragHelper.mInitialMotionX != null) {
                    if (viewDragHelper.mInitialMotionY != null) {
                        ...
                        for (actionIndex = 0; actionIndex < actionMasked; actionIndex++) {
                            ...
                            if (isValidPointerForActionMove(pointerId)) {
                                ...
                                float f = x - viewDragHelper.mInitialMotionX[pointerId];
                                float f2 = y2 - viewDragHelper.mInitialMotionY[pointerId];
                                ...
                                if (obj != null) {
                                    ...
                                    int i2 = (int) f;
                                    i2 = viewDragHelper.mCallback.clampViewPositionHorizontal(findTopChildUnder2, left + i2, i2);
                                    int top = findTopChildUnder2.getTop();
                                    int i3 = (int) f2;
                                    int clampViewPositionVertical = viewDragHelper.mCallback.clampViewPositionVertical(findTopChildUnder2, top + i3, i3);
                                    i3 = viewDragHelper.mCallback.getViewHorizontalDragRange(findTopChildUnder2);
                                    int viewVerticalDragRange = viewDragHelper.mCallback.getViewVerticalDragRange(findTopChildUnder2);
                                    if (i3 == 0 || (i3 > 0 && i2 == left)) {
                                ...
                                if (viewDragHelper.mDragState != 1) {
                                    if (obj != null && tryCaptureViewForDrag(findTopChildUnder2, pointerId)) {
                                        break;
                                    }
                                }
                                break;
            ...
            if (findTopChildUnder3 == viewDragHelper.mCapturedView && viewDragHelper.mDragState == 2) {
                tryCaptureViewForDrag(findTopChildUnder3, i);
            }
            actionMasked = viewDragHelper.mInitialEdgesTouched[i];
            actionIndex = viewDragHelper.mTrackingEdges;
            if ((actionMasked & actionIndex) != 0) {
                viewDragHelper.mCallback.onEdgeTouched(actionMasked & actionIndex, i);
            }
        }
