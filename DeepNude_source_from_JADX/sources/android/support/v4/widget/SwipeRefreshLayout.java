...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (swipeRefreshLayout.mRefreshing) {
                ...
                if (swipeRefreshLayout.mNotify) {
                    OnRefreshListener onRefreshListener = swipeRefreshLayout.mListener;
    ...
    class C02026 extends Animation {
        ...
        public void applyTransformation(float f, Transformation transformation) {
            ...
            SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((i + ((int) (((float) (abs - i)) * f))) - swipeRefreshLayout.mCircleView.getTop());
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        Animation c02004 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (getChildCount() != 0) {
            ...
            if (view != null) {
                ...
                imageView.layout(i4, i5, measuredWidth + i, i2 + i5);
            }
        }
    }
            ...
            if (!this.mNestedScrollInProgress) {
                if (actionMasked == 0) {
                    ...
                    if (this.mIsBeingDragged) {
                        r6 = (motionEvent.getY(actionMasked) - this.mInitialMotionY) * DRAG_RATE;
                        this.mIsBeingDragged = false;
                        finishSpinner(r6);
                    }
                    this.mActivePointerId = -1;
                    ...
                    r6 = motionEvent.getY(actionMasked);
                    startDragging(r6);
                    if (this.mIsBeingDragged) {
                        r6 = (r6 - this.mInitialMotionY) * DRAG_RATE;
                        if (r6 <= 0.0f) {
                            return false;
                        }
                        moveSpinner(r6);
